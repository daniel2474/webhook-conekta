...
public class CorreoFiserv
{
  ...
  public CorreoFiserv(String correoEnvia, String contrasena, String destinatario, String copiaoculta) {
  ...
  public void enviar_correo_aprobado(String Titular,int idCliente,String noMembresia,String fechaPago, String horaPago,
   ...
   try {
     mail.setFrom((Address)new InternetAddress(this.correoEnvia));
      ...
      Logger.getLogger(Correo.class.getName()).log(Level.SEVERE, (String)null, (Throwable)ex);
